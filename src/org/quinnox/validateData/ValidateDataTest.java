package org.quinnox.validateData;
...
public class ValidateDataTest {
	...
	@Test
	public void validatePostRequest() throws IOException, JSONException, InvalidFormatException, KeyManagementException, NoSuchAlgorithmException{
		...
		HttpsURLConnection responseFromAPI = cLib.getResponseTextToValidate(Resturl);
		...
		Assert.assertEquals(statusCode, 200,response+"!");
	}
}
